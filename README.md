...
|                                    |                                                                                                                                                                                                           |                                                                                                      |
| OTEL_BATCH_TIMEOUT                 |
`5s`                                 | Interval between pushes to OT Collector                                                          |
| OTEL_EXPORTER_OTLP_ENDPOINT        |
`http://localhost:4317`              | URL for OpenTelemetry endpoint                                                                   |
| OTEL_SERVICE_NAME                  |
`dp-dataset-api`                     | Service name to report to telemetry tools                                                        |
| OTEL_ENABLED                       |
`false`                              | Feature flag to enable OpenTelemetry
