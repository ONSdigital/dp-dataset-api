...
| KAFKA_CONSUMER_MIN_BROKERS_HEALTHY | 1 | The minimum number of consumer brokers needed |
| KAFKA_PRODUCER_MIN_BROKERS_HEALTHY | 1 | The minimum number of producer brokers needed |
