...
// 			DoGetCantabularFunc: func(ctx context.Context, cfg config.CantabularConfig) service.CantabularClient {
...
func (mock *InitialiserMock) DoGetCantabular(ctx context.Context, cfg config.CantabularConfig) service.CantabularClient {
