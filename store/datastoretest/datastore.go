...
func (mock *StorerMock) GetDataset(id string) (*models.Dataset, error) {
...
func (mock *StorerMock) GetEdition(datasetID string, editionID string) (*models.Edition, error) {
...
func (mock *StorerMock) GetEditions(id string) (*models.EditionResults, error) {
...
func (mock *StorerMock) GetVersion(datasetID string, editionID string, versionID string) (*models.Version, error) {
...
func (mock *StorerMock) GetVersions(datasetID string, editionID string) (*models.VersionResults, error) {
...
func (mock *StorerMock) UpsertDataset(id string, update interface{}) error {
...
func (mock *StorerMock) UpsertEdition(id string, update interface{}) error {
...
func (mock *StorerMock) UpsertVersion(id string, update interface{}) error {
