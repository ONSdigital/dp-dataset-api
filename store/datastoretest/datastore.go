...
func (mock *StorerMock) GetVersionStaticByPreviousEditionID(ctx context.Context, datasetID string, previousEditionID string, versionID int) (*models.Version, error) {
	if mock.GetVersionStaticByPreviousEditionIDFunc == nil {
		panic("StorerMock.GetVersionStaticByPreviousEditionIDFunc: method is nil but Storer.GetVersionStaticByPreviousEditionID was just called")
	}
	callInfo := struct {
		Ctx               context.Context
		DatasetID         string
...
// Check the length with:
//
//	len(mockedStorer.GetVersionStaticByPreviousEditionIDCalls())
func (mock *StorerMock) GetVersionStaticByPreviousEditionIDCalls() []struct {
	Ctx               context.Context
	DatasetID         string
	PreviousEditionID string
	VersionID         int
...
func (mock *StorerMock) GetVersionsStaticByPreviousEditionID(ctx context.Context, datasetID string, previousEditionID string, state string, offset int, limit int) ([]models.Version, int, error) {
	if mock.GetVersionsStaticByPreviousEditionIDFunc == nil {
		panic("StorerMock.GetVersionsStaticByPreviousEditionIDFunc: method is nil but Storer.GetVersionsStaticByPreviousEditionID was just called")
	}
	callInfo := struct {
		Ctx               context.Context
		DatasetID         string
...
// Check the length with:
//
//	len(mockedStorer.GetVersionsStaticByPreviousEditionIDCalls())
func (mock *StorerMock) GetVersionsStaticByPreviousEditionIDCalls() []struct {
	Ctx               context.Context
	DatasetID         string
	PreviousEditionID string
	State             string
...
func (mock *StorerMock) IsStaticDataset(ctx context.Context, datasetID string) (bool, error) {
	if mock.IsStaticDatasetFunc == nil {
		panic("StorerMock.IsStaticDatasetFunc: method is nil but Storer.IsStaticDataset was just called")
	}
	callInfo := struct {
		Ctx       context.Context
		DatasetID string
...
// Check the length with:
//
//	len(mockedStorer.IsStaticDatasetCalls())
func (mock *StorerMock) IsStaticDatasetCalls() []struct {
	Ctx       context.Context
	DatasetID string
} {
	var calls []struct {
