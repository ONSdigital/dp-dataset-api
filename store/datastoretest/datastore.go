...
func (mock *StorerMock) GetDimensionNodesFromInstance(ID string) (*models.DimensionNodeResults, error) {
	if mock.GetDimensionNodesFromInstanceFunc == nil {
		panic("StorerMock.GetDimensionNodesFromInstanceFunc: method is nil but Storer.GetDimensionNodesFromInstance was just called")
	}
	callInfo := struct {
		ID string
	}{
...
func (mock *StorerMock) GetUniqueDimensionValues(ID string, dimension string) (*models.DimensionValues, error) {
	if mock.GetUniqueDimensionValuesFunc == nil {
		panic("StorerMock.GetUniqueDimensionValuesFunc: method is nil but Storer.GetUniqueDimensionValues was just called")
	}
	callInfo := struct {
		ID        string
		Dimension string
...
func (mock *StorerMock) UpdateEdition(datasetID string, edition string, latestVersion *models.Version) error {
	if mock.UpdateEditionFunc == nil {
		panic("StorerMock.UpdateEditionFunc: method is nil but Storer.UpdateEdition was just called")
	}
	callInfo := struct {
		DatasetID     string
		Edition       string
