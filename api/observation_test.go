...
var (
	expectedObservationDoc = `{` +
		...
		`"observations":[{"observation":"146.3","metadata":{"confidence_interval":"2","data_marking":"p"}}],` +
...
func TestGetObservationsReturnsOK(t *testing.T) {
	...
	Convey("A successful request to get a single observation for a version of a dataset returns 200 OK response", t, func() {
		r := httptest.NewRequest("GET", "http://localhost:8080/datasets/cpih012/editions/2017/versions/1/observations?time=16-Aug\x26aggregate=*&geography=K02000001", nil)
		...
		mockedDataStore := &storetest.StorerMock{
			GetDatasetFunc: func(string) (*models.DatasetUpdate, error) {
				return &models.DatasetUpdate{Current: &models.Dataset{State: models.PublishedState, UnitOfMeasure: "Pounds Sterling"}}, nil
			},
...
// })
//
// Convey("When more than one query parameter is set to wildcard (*) value in request", t, func() {
// 	r := httptest.NewRequest("GET", "http://localhost:22000/datasets/cpih012/editions/2017/versions/1/observations?time=16-Aug&aggregate=*&geography=*", nil)
// 	w := httptest.NewRecorder()
// 	mockedDataStore := &storetest.StorerMock{
// 		GetDatasetFunc: func(datasetID string) (*models.DatasetUpdate, error) {
// 			return &models.DatasetUpdate{Current: &models.Dataset{State: models.PublishedState}}, nil
...
// TODO Remove test we can now return more than observation
