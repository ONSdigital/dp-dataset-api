...
func TestAddDatasetVersionCondensed_Success(t *testing.T) {
	...
	Convey("When distribution format is valid, media_type is populated", t, func() {
		...
		api := GetAPIWithCMDMocks(mockedDataStore, &mocks.DownloadsGeneratorMock{},
			authorisationMock, application.SearchContentUpdatedProducer{}, &cloudflareMocks.ClienterMock{}, auditServiceMock, &applicationMocks.StaticDatasetServiceMock{}, nil, &filesAPISDKMocks.ClienterMock{})
...
func TestAddDatasetVersionCondensed_Failure(t *testing.T) {
	...
	Convey("When given format is missing, return 400 with missing field error", t, func() {
		...
		api := GetAPIWithCMDMocks(
			...
			&applicationMocks.AuditServiceMock{}, &applicationMocks.StaticDatasetServiceMock{},
			nil,
	...
	Convey("When AuditService fails to record a version audit event", t, func() {
		b := `{
			"edition_title": "Edition Title 2025",
			"release_date": "2025-01-15",
			"distributions": [
		...
		auditServiceMock := &applicationMocks.AuditServiceMock{
			RecordVersionAuditEventFunc: func(ctx context.Context, requestedBy models.RequestedBy, action models.Action, resource string, version *models.Version) error {
				return errors.New("audit service failed")
			},
		}
...
func TestCreateVersion_Failure(t *testing.T) {
	...
	Convey("When the auth middleware fails to get auth entity data", t, func() {
		...
		api := GetAPIWithCMDMocks(&storetest.StorerMock{}, &mocks.DownloadsGeneratorMock{}, failingAuthorisationMock, application.SearchContentUpdatedProducer{}, &cloudflareMocks.ClienterMock{}, &applicationMocks.AuditServiceMock{}, &applicationMocks.StaticDatasetServiceMock{}, nil, &filesAPISDKMocks.ClienterMock{})
	...
	Convey("When the AuditService returns an error", t, func() {
		validVersionJSON, err := json.Marshal(validVersion)
		So(err, ShouldBeNil)
	...
	Convey("When the distribution format field is missing", t, func() {
		...
		api := GetAPIWithCMDMocks(&storetest.StorerMock{}, &mocks.DownloadsGeneratorMock{},
			authorisationMock, application.SearchContentUpdatedProducer{}, &cloudflareMocks.ClienterMock{}, &applicationMocks.AuditServiceMock{}, &applicationMocks.StaticDatasetServiceMock{}, nil, &filesAPISDKMocks.ClienterMock{})
...
func TestCreateVersion_WebPageLink(t *testing.T) {
	...
	Convey("When topic API client is set and returns a valid slug, web_page link is set on the version", t, func() {
		...
		api := GetAPIWithCMDMocks(mockedDataStore, &mocks.DownloadsGeneratorMock{}, authorisationMock, application.SearchContentUpdatedProducer{}, &cloudflareMocks.ClienterMock{}, auditServiceMock, &applicationMocks.StaticDatasetServiceMock{}, topicClientMock, &filesAPISDKMocks.ClienterMock{})
