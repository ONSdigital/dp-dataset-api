...
// }
//
// func GetWebAPIWithMockedDatastore(mockedDataStore store.Storer, mockedGeneratedDownloads DownloadsGenerator, mockedObservationStore ObservationStore) *DatasetAPI {
// 	cfg, err := config.Get()
// 	So(err, ShouldBeNil)
