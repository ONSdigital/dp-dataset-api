...
func TestGetDimensionsReturnsOk(t *testing.T) {
	...
	convey.Convey("When the request contain valid ids return dimension information", t, func() {
		...
		convey.So(len(mockedDataStore.GetDimensionsCalls()), convey.ShouldEqual, 1)
	})
}
...
func TestGetDimensionsReturnsErrors(t *testing.T) {
	...
	convey.Convey("When the api cannot connect to datastore to get dimension resource return an internal server error", t, func() {
		r := httptest.NewRequest("GET", "http://localhost:22000/datasets/123/editions/2017/versions/1/dimensions", http.NoBody)
		w := httptest.NewRecorder()
		mockedDataStore := &storetest.StorerMock{
			GetVersionFunc: func(ctx context.Context, datasetID, edition string, version int, state string) (*models.Version, error) {
		...
		convey.So(len(mockedDataStore.GetVersionCalls()), convey.ShouldEqual, 1)
		convey.So(len(mockedDataStore.GetDimensionsCalls()), convey.ShouldEqual, 0)
	})

	convey.Convey("When the request contain an invalid version return not found", t, func() {
		r := httptest.NewRequest("GET", "http://localhost:22000/datasets/123/editions/2017/versions/1/dimensions", http.NoBody)
		w := httptest.NewRecorder()
		mockedDataStore := &storetest.StorerMock{
			GetVersionFunc: func(ctx context.Context, datasetID, edition string, version int, state string) (*models.Version, error) {
	...
	convey.Convey("When the request contains an invalid, non-numeric version, return 400 bad request", t, func() {
	...
	convey.Convey("When there are no dimensions then return not found error", t, func() {
		r := httptest.NewRequest("GET", "http://localhost:22000/datasets/123/editions/2017/versions/1/dimensions", http.NoBody)
		w := httptest.NewRecorder()
		mockedDataStore := &storetest.StorerMock{
			GetVersionFunc: func(ctx context.Context, datasetID, edition string, version int, state string) (*models.Version, error) {
		...
		convey.So(w.Code, convey.ShouldEqual, http.StatusNotFound)
		convey.So(w.Body.String(), convey.ShouldContainSubstring, errs.ErrDimensionsNotFound.Error())
		convey.So(len(mockedDataStore.GetVersionCalls()), convey.ShouldEqual, 1)
		convey.So(len(mockedDataStore.GetDimensionsCalls()), convey.ShouldEqual, 1)
	})

	convey.Convey("When the version has an invalid state return internal server error", t, func() {
		r := httptest.NewRequest("GET", "http://localhost:22000/datasets/123/editions/2017/versions/1/dimensions", http.NoBody)
		w := httptest.NewRecorder()
		mockedDataStore := &storetest.StorerMock{
			GetVersionFunc: func(ctx context.Context, datasetID, edition string, version int, state string) (*models.Version, error) {
...
func TestGetDimensionOptionsReturnsOk(t *testing.T) {
	convey.Convey("Given a store with a dimension with 5 options", t, func() {
		...
		validateCalls := func(expectedIDs *[]string) {
			convey.So(len(mockedDataStore.GetVersionCalls()), convey.ShouldEqual, 1)
			if expectedIDs == nil {
				convey.So(mockedDataStore.GetDimensionOptionsCalls(), convey.ShouldHaveLength, 1)
				convey.So(mockedDataStore.GetDimensionOptionsFromIDsCalls(), convey.ShouldHaveLength, 0)
				convey.So(mockedDataStore.GetDimensionOptionsCalls()[0].Dimension, convey.ShouldEqual, "age")
				convey.So(mockedDataStore.GetDimensionOptionsCalls()[0].Version.ID, convey.ShouldEqual, "v1")
			} else {
				convey.So(mockedDataStore.GetDimensionOptionsCalls(), convey.ShouldHaveLength, 0)
				convey.So(mockedDataStore.GetDimensionOptionsFromIDsCalls(), convey.ShouldHaveLength, 1)
				convey.So(mockedDataStore.GetDimensionOptionsFromIDsCalls()[0].Dimension, convey.ShouldEqual, "age")
				convey.So(mockedDataStore.GetDimensionOptionsFromIDsCalls()[0].Version.ID, convey.ShouldEqual, "v1")
				convey.So(mockedDataStore.GetDimensionOptionsFromIDsCalls()[0].Ids, convey.ShouldResemble, *expectedIDs)
			}
		}
		...
		convey.Convey("When a valid dimension is provided without any query parameters", func() {
			...
			convey.Convey("Then the call succeeds with 200 OK code, expected body and calls", func() {
				...
				convey.So(totalCount, convey.ShouldEqual, 5)
				convey.So(err, convey.ShouldBeNil)
				validateCalls(nil)
			})
		})

		convey.Convey("When a valid dimension and list of existing IDs is provided in more than one parameter, in comma-separated format", func() {
		...
		convey.Convey("When a valid offset, limit and dimension and list of existing IDs are provided", func() {
			...
			convey.Convey("Then the call succeeds with 200 OK code, the list of IDs take precedence (offset and limit are ignored), and the expected body and calls are performed", func() {
				expectedList := []*models.PublicDimensionOption{
					{Option: "op1", Links: expectedLinks},
					{Option: "op3", Links: expectedLinks},
				}
...
func TestGetDimensionOptionsReturnsErrors(t *testing.T) {
	...
	convey.Convey("Given a set of mocked dependencies", t, func() {
		convey.Convey("Then providing more IDs than the maximum allowed results in 400 BadRequest response", func() {
			...
			convey.So(w.Code, convey.ShouldEqual, http.StatusBadRequest)
			convey.So(w.Body.String(), convey.ShouldContainSubstring, errs.ErrTooManyQueryParameters.Error())
		})
	})

	convey.Convey("When the version doesn't exist in a request for dimension options, then return not found", t, func() {
		r := httptest.NewRequest("GET", "http://localhost:22000/datasets/123/editions/2017/versions/1/dimensions/age/options", http.NoBody)
		w := httptest.NewRecorder()
		mockedDataStore := &storetest.StorerMock{
			GetVersionFunc: func(ctx context.Context, datasetID, edition string, version int, state string) (*models.Version, error) {
	...
	convey.Convey("When an internal error causes failure to retrieve dimension options, then return internal server error", t, func() {
		r := httptest.NewRequest("GET", "http://localhost:22000/datasets/123/editions/2017/versions/1/dimensions/age/options", http.NoBody)
		w := httptest.NewRecorder()
		mockedDataStore := &storetest.StorerMock{
			GetVersionFunc: func(ctx context.Context, datasetID, edition string, version int, state string) (*models.Version, error) {
		...
		convey.So(w.Body.String(), convey.ShouldContainSubstring, errs.ErrInternalServer.Error())
		convey.So(len(mockedDataStore.GetVersionCalls()), convey.ShouldEqual, 1)
		convey.So(len(mockedDataStore.GetDimensionOptionsCalls()), convey.ShouldEqual, 1)
	})

	convey.Convey("When an internal error causes failure to retrieve dimension options from IDs, then return internal server error", t, func() {
		...
		convey.So(w.Body.String(), convey.ShouldContainSubstring, errs.ErrInternalServer.Error())
		convey.So(len(mockedDataStore.GetVersionCalls()), convey.ShouldEqual, 1)
		convey.So(len(mockedDataStore.GetDimensionOptionsFromIDsCalls()), convey.ShouldEqual, 1)
	})
