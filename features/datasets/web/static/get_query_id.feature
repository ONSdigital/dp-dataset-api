Feature: Query datasets by ID
  ...
  Scenario: Query a dataset by its exact ID
  ...
  Scenario: Query datasets using a partial ID match
  ...
  Scenario: Query datasets using a partial ID match and a specific type
  ...
  Scenario: Query datasets with an invalid id parameter
  ...
  Scenario: Query datasets with an empty id parameter
