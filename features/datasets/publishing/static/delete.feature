Feature: Delete static dataset in publishing mode
  ...
  Scenario: Delete a dataset with unpublished versions
  ...
  Scenario: Delete a dataset where the Files API returns an error
    Given I am an admin user
  ...
  Scenario: Delete a dataset with no versions
    Given I am an admin user
