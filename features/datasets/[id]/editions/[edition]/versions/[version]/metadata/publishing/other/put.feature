Feature: Update version metadata in publishing mode
  ...
  Scenario: Update metadata using an etag
  ...
  Scenario: Update metadata without using an etag
    Given I am an admin user
  ...
  Scenario: Update metadata using a * etag
    Given I am an admin user
  ...
  Scenario: Update metadata on a published dataset
    Given I am an admin user
  ...
  Scenario: Update metadata on a version that is published
    Given I am an admin user
  ...
  Scenario: Update metadata using the wrong etag
    Given I am an admin user
  ...
  Scenario: Update metadata for a dataset that does not exist
    Given I am an admin user
  ...
  Scenario: Update metadata for an edition that does not exist
    Given I am an admin user
    When I set the "If-Match" header to "an-etag"
  ...
  Scenario: Update metadata for a version that does not exist
    Given I am an admin user
    When I set the "If-Match" header to "an-etag"
