Feature: Update static version state in publishing mode
  ...
  Scenario: Update version state from approved to published
    ...
    And the following URL prefixes are purged by cloudflare:
      ...
      | localhost:20000/economy/datasets/static-dataset-publish/editions/2025                 |
      | localhost:20000/economy/datasets/static-dataset-publish/editions/2025/versions        |
      | localhost:20000/economy/datasets/static-dataset-publish/editions/2025/versions/1      |
      | localhost:23200/v1/datasets/static-dataset-publish                                    |
      | localhost:23200/v1/datasets/static-dataset-publish/editions                           |
      | localhost:23200/v1/datasets/static-dataset-publish/editions/2025                      |
      | localhost:23200/v1/datasets/static-dataset-publish/editions/2025/versions             |
      | localhost:23200/v1/datasets/static-dataset-publish/editions/2025/versions/1           |
      | localhost:23200/v1/datasets/static-dataset-publish/editions/2025/versions/1/metadata  |
