Feature: List dataset editions
  ...
  Scenario: List dataset editions
  ...
  Scenario: List dataset editions with state associated
    Given I am an admin user
  ...
  Scenario: List dataset editions with state published
    Given I am an admin user
  ...
  Scenario: List dataset editions with state not published
    Given I am an admin user
  ...
  Scenario: List dataset editions with invalid published parameter
    Given I am an admin user
  ...
  Scenario: List dataset editions with state and published parameters
    Given I am an admin user
  ...
  Scenario: List dataset editions when there are no datasets
    Given I am an admin user
  ...
  Scenario: List dataset editions with state associated when there are no matching results
    Given I am an admin user
    And there are no datasets
    And I have these static versions:
      """
  ...
  Scenario: List dataset editions when user is not authorised
    When I GET "/dataset-editions"
