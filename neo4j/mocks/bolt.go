...
func (mock *BoltStmtMock) Close() error {
	if mock.CloseFunc == nil {
		panic("BoltStmtMock.CloseFunc: method is nil but BoltStmt.Close was just called")
	}
	callInfo := struct {
	}{}
...
func (mock *BoltStmtMock) ExecNeo(params map[string]interface{}) (golangNeo4jBoltDriver.Result, error) {
	if mock.ExecNeoFunc == nil {
		panic("BoltStmtMock.ExecNeoFunc: method is nil but BoltStmt.ExecNeo was just called")
	}
	callInfo := struct {
		Params map[string]interface{}
	}{
...
func (mock *BoltStmtMock) QueryNeo(params map[string]interface{}) (golangNeo4jBoltDriver.Rows, error) {
	if mock.QueryNeoFunc == nil {
		panic("BoltStmtMock.QueryNeoFunc: method is nil but BoltStmt.QueryNeo was just called")
	}
	callInfo := struct {
		Params map[string]interface{}
	}{
...
func (mock *BoltResultMock) LastInsertId() (int64, error) {
	if mock.LastInsertIdFunc == nil {
		panic("BoltResultMock.LastInsertIdFunc: method is nil but BoltResult.LastInsertId was just called")
	}
	callInfo := struct {
	}{}
...
func (mock *BoltResultMock) Metadata() map[string]interface{} {
	if mock.MetadataFunc == nil {
		panic("BoltResultMock.MetadataFunc: method is nil but BoltResult.Metadata was just called")
	}
	callInfo := struct {
	}{}
...
func (mock *BoltResultMock) RowsAffected() (int64, error) {
	if mock.RowsAffectedFunc == nil {
		panic("BoltResultMock.RowsAffectedFunc: method is nil but BoltResult.RowsAffected was just called")
	}
	callInfo := struct {
	}{}
