...
func TestRewriteDatasetLinks_Success(t *testing.T) {
	...
	Convey("Given a set of dataset links", t, func() {
		...
		Convey("When the dataset links need rewriting", func() {
			...
			err := RewriteDatasetLinks(ctx, oldLinks, datasetLinksBuilder)

			Convey("Then the links should be rewritten correctly", func() {
				So(err, ShouldBeNil)
				So(oldLinks.AccessRights.HRef, ShouldEqual, "https://oldhost:1000/accessrights")
				So(oldLinks.Editions.HRef, ShouldEqual, "http://localhost:22000/datasets/123/editions")
				So(oldLinks.LatestVersion.HRef, ShouldEqual, "http://localhost:22000/datasets/123/editions/time-series/versions/1")
				So(oldLinks.Self.HRef, ShouldEqual, "http://localhost:22000/datasets/123")
				So(oldLinks.Taxonomy.HRef, ShouldEqual, "http://localhost:22000/economy/inflationandpriceindices")
			})
		})
		...
		Convey("When the dataset links are empty", func() {
			...
			Convey("Then the links should remain empty", func() {
				So(err, ShouldBeNil)
				So(oldLinks, ShouldResemble, &models.DatasetLinks{})
			})
		})
...
func TestRewriteDatasetLinks_Error(t *testing.T) {
	...
	Convey("Given a set of dataset links", t, func() {
		Convey("When the dataset links are unable to be parsed", func() {
			...
			err := RewriteDatasetLinks(ctx, oldLinks, nil)
...
func TestRewriteDimensionLinks_Success(t *testing.T) {
	...
	Convey("Given a set of dimension links", t, func() {
		...
		Convey("When the dimension links need rewriting", func() {
			...
			err := RewriteDimensionLinks(ctx, &oldLinks, datasetLinksBuilder, codeListLinksBuilder)

			Convey("Then the links should be rewritten correctly", func() {
				So(err, ShouldBeNil)
				So(oldLinks.CodeList.HRef, ShouldEqual, "http://localhost:22400/code-lists/cpih1dim1aggid")
				So(oldLinks.Options.HRef, ShouldEqual, "http://localhost:22000/datasets/cpih01/editions/time-series/versions/1/dimensions/aggregate/options")
				So(oldLinks.Version.HRef, ShouldEqual, "http://localhost:22000/datasets/cpih01/editions/time-series/versions/1")
			})
		})
		...
		Convey("When the dimension links are empty", func() {
			...
			Convey("Then the links should remain empty", func() {
				So(err, ShouldBeNil)
				So(oldLinks, ShouldResemble, models.DimensionLink{})
			})
		})
...
func TestRewriteDimensionOptionLinks_Success(t *testing.T) {
	...
	Convey("Given a set of dimension option links", t, func() {
		...
		Convey("When the dimension option links need rewriting", func() {
			oldLinks := models.DimensionOptionLinks{
				Code: models.LinkObject{
					HRef: "https://oldhost:1000/code-lists/cpih1dim1aggid/codes/cpih1dim1G10100",
					ID:   "cpih1dim1G10100",
				},
			...
			err := RewriteDimensionOptionLinks(ctx, &oldLinks, datasetLinksBuilder, codeListLinksBuilder)

			Convey("Then the links should be rewritten correctly", func() {
				So(err, ShouldBeNil)
				So(oldLinks.Code.HRef, ShouldEqual, "http://localhost:22400/code-lists/cpih1dim1aggid/codes/cpih1dim1G10100")
				So(oldLinks.CodeList.HRef, ShouldEqual, "http://localhost:22400/code-lists/cpih1dim1aggid")
				So(oldLinks.Version.HRef, ShouldEqual, "http://localhost:22000/datasets/cpih01/editions/time-series/versions/1")
			})
		})
		...
		Convey("When the dimension option links are empty", func() {
			...
			Convey("Then the links should remain empty", func() {
				So(err, ShouldBeNil)
				So(oldLinks, ShouldResemble, models.DimensionOptionLinks{})
			})
		})
...
func TestRewriteEditionLinks_Success(t *testing.T) {
	...
	Convey("Given a set of edition update links", t, func() {
		...
		Convey("When the edition update links need rewriting", func() {
			oldLinks := &models.EditionUpdateLinks{
				Dataset: &models.LinkObject{
					HRef: "https://oldhost:1000/datasets/cpih01",
					ID:   "cpih01",
				},
			...
			err := RewriteEditionLinks(ctx, oldLinks, datasetLinksBuilder)

			Convey("Then the links should be rewritten correctly", func() {
				So(err, ShouldBeNil)
				So(oldLinks.Dataset.HRef, ShouldEqual, "http://localhost:22000/datasets/cpih01")
				So(oldLinks.LatestVersion.HRef, ShouldEqual, "http://localhost:22000/datasets/cpih01/editions/time-series/versions/1")
				So(oldLinks.Self.HRef, ShouldEqual, "http://localhost:22000/datasets/cpih01/editions/time-series")
				So(oldLinks.Versions.HRef, ShouldEqual, "http://localhost:22000/datasets/cpih01/editions/time-series/versions")
			})
		})
		...
		Convey("When the edition update links are empty", func() {
			...
			Convey("Then the links should remain empty", func() {
				So(err, ShouldBeNil)
				So(oldLinks, ShouldResemble, &models.EditionUpdateLinks{})
			})
		})
...
func TestRewriteEditionLinks_Error(t *testing.T) {
	...
	Convey("Given a set of edition update links", t, func() {
		Convey("When the edition update links are unable to be parsed", func() {
			...
			err := RewriteEditionLinks(ctx, oldLinks, nil)
...
func TestRewriteMetadataLinks_Success(t *testing.T) {
	...
	Convey("Given a set of metadata links", t, func() {
		...
		Convey("When the metadata links need rewriting", func() {
			...
			err := RewriteMetadataLinks(ctx, oldLinks, datasetLinksBuilder)

			Convey("Then the links should be rewritten correctly", func() {
				So(err, ShouldBeNil)
				So(oldLinks.AccessRights.HRef, ShouldEqual, "https://oldhost:1000/accessrights")
				So(oldLinks.Self.HRef, ShouldEqual, "http://localhost:22000/datasets/cpih01/editions/time-series/versions/1/metadata")
				So(oldLinks.Version.HRef, ShouldEqual, "http://localhost:22000/datasets/cpih01/editions/time-series/versions/1")
				So(oldLinks.Version.ID, ShouldEqual, "1")
				So(oldLinks.WebsiteVersion.HRef, ShouldEqual, "https://oldhost:1000/datasets/cpih01/editions/time-series/versions/1")
			})
		})
		...
		Convey("When the metadata links do not need rewriting", func() {
			...
			Convey("Then the links should remain the same", func() {
				So(err, ShouldBeNil)
				So(oldLinks.AccessRights.HRef, ShouldEqual, "http://localhost:22000/accessrights")
				So(oldLinks.Self.HRef, ShouldEqual, "http://localhost:22000/datasets/cpih01/editions/time-series/versions/1/metadata")
				So(oldLinks.Version.HRef, ShouldEqual, "http://localhost:22000/datasets/cpih01/editions/time-series/versions/1")
				So(oldLinks.Version.ID, ShouldEqual, "1")
				So(oldLinks.WebsiteVersion.HRef, ShouldEqual, "http://localhost:20000/datasets/cpih01/editions/time-series/versions/1")
			})
		})
		...
		Convey("When the metadata links are empty", func() {
			...
			Convey("Then the links should remain empty", func() {
				So(err, ShouldBeNil)
				So(oldLinks, ShouldResemble, &models.MetadataLinks{})
			})
		})
...
func TestRewriteVersionLinks_Success(t *testing.T) {
	...
	Convey("Given a set of version links", t, func() {
		...
		Convey("When the version links need rewriting", func() {
			...
			err := RewriteVersionLinks(ctx, oldLinks, datasetLinksBuilder)

			Convey("Then the links should be rewritten correctly", func() {
				So(err, ShouldBeNil)
				So(oldLinks.Dataset.HRef, ShouldEqual, "http://localhost:22000/datasets/cpih01")
				So(oldLinks.Dimensions.HRef, ShouldEqual, "http://localhost:22000/datasets/cpih01/editions/time-series/versions/1/dimensions")
				So(oldLinks.Edition.HRef, ShouldEqual, "http://localhost:22000/datasets/cpih01/editions/time-series")
				So(oldLinks.Self.HRef, ShouldEqual, "http://localhost:22000/datasets/cpih01/editions/time-series/versions/1")
				So(oldLinks.Spatial.HRef, ShouldEqual, "https://oldhost:1000/spatial")
				So(oldLinks.Version.HRef, ShouldEqual, "http://localhost:22000/datasets/cpih01/editions/time-series/versions/1")
				So(oldLinks.Version.ID, ShouldEqual, "1")
			})
		})
		...
		Convey("When the version links do not need rewriting", func() {
			...
			Convey("Then the links should remain the same", func() {
				...
				So(oldLinks.Edition.HRef, ShouldEqual, "http://localhost:22000/datasets/cpih01/editions/time-series")
				So(oldLinks.Self.HRef, ShouldEqual, "http://localhost:22000/datasets/cpih01/editions/time-series/versions/1")
				So(oldLinks.Spatial.HRef, ShouldEqual, "http://oldhost:1000/spatial")
				So(oldLinks.Version.HRef, ShouldEqual, "http://localhost:22000/datasets/cpih01/editions/time-series/versions/1")
				So(oldLinks.Version.ID, ShouldEqual, "1")
			})
		})
		...
		Convey("When the version links are empty", func() {
			...
			Convey("Then the links should remain empty", func() {
				So(err, ShouldBeNil)
				So(oldLinks, ShouldResemble, &models.VersionLinks{})
			})
		})
...
func TestRewriteVersionLinks_Error(t *testing.T) {
	...
	Convey("Given a set of version links", t, func() {
		Convey("When the version links are unable to be parsed", func() {
			...
			err := RewriteVersionLinks(ctx, oldLinks, nil)
...
func TestRewriteInstanceLinks_Success(t *testing.T) {
	...
	Convey("Given a set of instance links", t, func() {
		...
		Convey("When the instance links need rewriting", func() {
			...
			err := RewriteInstanceLinks(ctx, oldLinks, datasetLinksBuilder, importLinksBuilder)
			...
			Convey("Then the links should be rewritten correctly", func() {
				...
				So(oldLinks.Dimensions.HRef, ShouldEqual, "http://localhost:22000/datasets/cpih01/editions/time-series/versions/1/dimensions")
				So(oldLinks.Edition.HRef, ShouldEqual, "http://localhost:22000/datasets/cpih01/editions/time-series")
				So(oldLinks.Job.HRef, ShouldEqual, "http://localhost:21800/jobs/1")
				So(oldLinks.Self.HRef, ShouldEqual, "http://localhost:22000/instances/1")
				So(oldLinks.Spatial.HRef, ShouldEqual, "http://oldhost:1000/spatial")
				So(oldLinks.Version.HRef, ShouldEqual, "http://localhost:22000/datasets/cpih01/editions/time-series/versions/1")
			})
		})
		...
		Convey("When the instance links are empty", func() {
			...
			Convey("Then the links should remain empty", func() {
				So(err, ShouldBeNil)
				So(oldLinks, ShouldResemble, &models.InstanceLinks{})
			})
		})
...
func TestRewriteInstanceLinks_Error(t *testing.T) {
	...
	Convey("Given a set of instance links", t, func() {
		...
		Convey("When the instance links are unable to be parsed", func() {
			...
			err := RewriteInstanceLinks(ctx, oldLinks, nil, nil)
...
func TestRewriteDownloadLinks_Success(t *testing.T) {
	...
	Convey("Given a set of download links", t, func() {
		Convey("When the download links need rewriting", func() {
			...
			err := RewriteDownloadLinks(ctx, oldLinks, downloadServiceURL)

			Convey("Then the links should be rewritten correctly", func() {
				So(err, ShouldBeNil)
				So(oldLinks.CSV.HRef, ShouldEqual, "http://localhost:23600/downloads/datasets/cpih01/editions/time-series/versions/1.csv")
				So(oldLinks.CSV.Size, ShouldEqual, "15000")
				So(oldLinks.CSVW.HRef, ShouldEqual, "http://localhost:23600/downloads/datasets/cpih01/editions/time-series/versions/1.csv-metadata.json")
				So(oldLinks.CSVW.Size, ShouldEqual, "30000")
				So(oldLinks.TXT.HRef, ShouldEqual, "http://localhost:23600/downloads/datasets/cpih01/editions/time-series/versions/1.txt")
				So(oldLinks.TXT.Size, ShouldEqual, "45000")
				So(oldLinks.XLS.HRef, ShouldEqual, "http://localhost:23600/downloads/datasets/cpih01/editions/time-series/versions/1.xls")
				So(oldLinks.XLS.Size, ShouldEqual, "60000")
				So(oldLinks.XLSX.HRef, ShouldEqual, "http://localhost:23600/downloads/datasets/cpih01/editions/time-series/versions/1.xlsx")
				So(oldLinks.XLSX.Size, ShouldEqual, "75000")
			})
		})
		...
		Convey("When the download links are empty", func() {
			...
			Convey("Then the links should remain empty", func() {
				So(err, ShouldBeNil)
				So(oldLinks, ShouldResemble, &models.DownloadList{})
			})
		})
